...
function validateNumberInput(a, b, c) {
  if (typeof a !== "number") {
    ...
    throw new SyntaxError("Argumen kedua harus number");
  } else if (typeof c !== "number") {
    throw new SyntaxError("Argumen ketiga harus number");
  }
}
...
console.log(detectTriangle(false, 1, 3));
console.log(detectTriangle(1, 1, "a"));
console.log(detectTriangle(2, null, 2));
