// contoh ifelse biasa
let jange = "muammar rizal";
if (jange == "muammar rizal") {
  console.log(`hei ${jange}`);
} else if (jange == "topet") {
  console.log("masukan nama asli");
} else {
  console.log("masukin nama dulu lah");
}

// contoh ternary
let jangs = "jange";
let namaPanggil = jangs == "jange" ? "benar jange" : "salah jange";
console.log(namaPanggil);

// contoh falsy dan truthy
let x = "jange";
if (x) {
  console.log("hello");
} else {
...
// jika kita memberi nilai kosong pada variable akan bernilai boolean false dan jika ada isinya true
