...
// fungsi ini untuk mengembalikan array yang ada di local storage,dan jika tidak ada maka akan mengembalikan array kosong
...
window.addEventListener("load", function () {
  if (checkForStorage) {
    ...
    alert("Browser anda tidak dapat mendukung web storage");
  }
});
